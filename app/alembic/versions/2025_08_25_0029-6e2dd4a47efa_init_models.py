...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix__users__users_email"), "users", ["email"], unique=True
    )
    op.create_table(
        "accounts",
        sa.Column("name", sa.String(length=120), nullable=False),
        ...
        sa.Column(
            "balance", sa.Numeric(precision=14, scale=2), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("amount", sa.Numeric(precision=14, scale=2), nullable=False),
        sa.Column(
            "fee_amount", sa.Numeric(precision=14, scale=2), nullable=True
        ),
        sa.Column("note", sa.String(length=500), nullable=True),
        sa.Column("occurred_at", sa.DateTime(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix__transfers__transfers_user_id"), table_name="transfers"
    )
    ...
    op.drop_index(
        op.f("ix__budgets__budgets_category_id"), table_name="budgets"
    )
    op.drop_table("budgets")
    op.drop_index(
        op.f("ix__categories__categories_user_id"), table_name="categories"
    )
    op.drop_table("categories")
    op.drop_index(
        op.f("ix__accounts__accounts_user_id"), table_name="accounts"
    )
